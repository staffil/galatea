"use strict";import{jsx as o,jsxs as T}from"react/jsx-runtime";import{bezier as C,spring as R}from"@toss/tds-easings";import{josa as A}from"es-hangul";import{useCallback as G,useEffect as E,useLayoutEffect as Q,useMemo as X,useRef as Z,useState as w}from"react";import{Dimensions as ee,Easing as v,Platform as te,Pressable as oe,StyleSheet as O,useAnimatedValue as r,View as L}from"react-native";import{usePreservedCallback as k}from"../../components/bottom-sheet/utils/usePreservedCallback.js";import{LinearGradient as re,RadialGradient as B}from"../../components/gradient/index.js";import{Text as z}from"../../components/txt/index.js";import{useTheme as ie}from"../../core/theme/ThemeProvider.js";import{Animated as t}from"../../interactions/animated/Animated.js";import{Icon as ne,NestedShadow as ae}from"./components/index.js";import{getCenterOffset as N}from"./utils/index.js";const le=600,se=400;export function Bridge({style:a,icon:f,open:c,colorMode:p="basic",onClose:l,onExited:y,variant:x,serviceName:u,amount:s,...m}){const{token:e}=ie(),g=p==="basic",D=k(l??Y),I=k(y??Y),[j,P]=w(!1),b=Z(null),_=G(()=>{b.current&&clearTimeout(b.current),b.current=setTimeout(()=>{D?.(),b.current=null},se)},[D]);E(()=>()=>{b.current&&clearTimeout(b.current)},[]),E(()=>{const d=setTimeout(()=>{P(!0)},le);return()=>{clearTimeout(d)}},[]);const h={large:412.5,small:375},i=ge();E(()=>{if(c)return i.controller.open().start(),()=>{D?.(),i.controller.close().start(()=>{I?.()})}},[i.controller,D,I,c]);const M=x==="point"?[{type:"strong",text:u},{type:"default",text:A.pick(u,"\uC73C\uB85C/\uB85C")+` \uC774\uB3D9\uD558\uACE0
