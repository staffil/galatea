...
import type { BaseAgreementFieldProps } from './BaseAgreementField.js';
import BaseAgreementField from './BaseAgreementField.js';
...
declare namespace AgreementField {
    var AddonText: ({ color, style, ...props }: Omit<import("../txt/Txt.js").TxtProps, "typography">) => import("react/jsx-runtime").JSX.Element;
